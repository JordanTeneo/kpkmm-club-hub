...
export default function Home() {
  return <main>
    ...
    <section id="gallery"><p className="eyebrow">SHARED MOMENTS</p><h2>Outings, captured</h2><div className="gallery">{[...Array(6)].map((_, i) => <figure key={i}><Image src={photos[i % 3]} alt="Classic mini-car community outing" fill sizes="33vw" unoptimized /><figcaption>{["Fire & wheel", "Club gathering", "On the road", "15 years together", "Mini heritage", "KPKMM family"][i]}</figcaption></figure>)}</div></section>
